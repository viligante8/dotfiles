    ...
    config = function()
      ...
      vim.defer_fn(function()
        ...
        if health.healthy then
          print("✅ Amazon Q LSP is healthy!")
        else
          print("❌ Amazon Q LSP has issues:")
        ...
        if cred_req then
          if cred_req.metadata and cred_req.metadata.sso then
            print("✅ SSO Bearer Token authentication detected!")
            print("  Will use: aws/credentials/token/update")
          else
            print("ℹ️ IAM authentication detected")
        ...
        print("\n🎯 AWS_PROFILE issue verification complete!")
      ...
      amazon_q.setup({
        ...
        on_attach = function(client, bufnr)
          print("✅ Amazon Q LSP attached to buffer:", vim.api.nvim_buf_get_name(bufnr))
        ...
        on_error = function(error)
          print("❌ Amazon Q LSP error:", error)
        end,
      })
